...
class _PatientInfoScreenState extends State<PatientInfoScreen>
      ...
      children: [
        ...
        SizedBox(
          ...
          child: ListView(
            ...
            children: [
              _buildRecentPatientCard(
                  'John Doe', '+91 9876543210', '15 Jun 2023', Icons.male),
              const SizedBox(width: 12),
              _buildRecentPatientCard(
                  'Jane Smith', '+91 8765432109', '10 Jun 2023', Icons.female),
              const SizedBox(width: 12),
              _buildRecentPatientCard('Robert Johnson', '+91 7654321098',
                  '5 Jun 2023', Icons.male),
              const SizedBox(width: 12),
              _buildRecentPatientCard('Sarah Williams', '+91 6543210987',
                  '1 Jun 2023', Icons.female),
            ],
          ),
        ),
      ],
  ...
  Widget _buildRecentPatientCard(
      String name, String phone, String lastVisit, IconData genderIcon) {
    return GestureDetector(
      onTap: () {
        setState(() {
          _nameController.text = name;
